...
V_76 = Vertex(name = 'V_76',
              particles = [ P.a, P.V, P.G__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_56})

V_77 = Vertex(name = 'V_77',
              particles = [ P.V, P.G0, P.H ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_55})

V_78 = Vertex(name = 'V_78',
              particles = [ P.V, P.G__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_52})

V_79 = Vertex(name = 'V_79',
              particles = [ P.P__tilde__chibar, P.P__tilde__chi, P.V ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
...
V_86 = Vertex(name = 'V_86',
              particles = [ P.V, P.W__minus__, P.G0, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_80})

V_87 = Vertex(name = 'V_87',
              particles = [ P.V, P.W__minus__, P.G__plus__, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_79})

V_88 = Vertex(name = 'V_88',
              particles = [ P.V, P.W__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
...
V_94 = Vertex(name = 'V_94',
              particles = [ P.V, P.W__plus__, P.G0, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_80})

V_95 = Vertex(name = 'V_95',
              particles = [ P.V, P.W__plus__, P.G__minus__, P.H ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_81})

V_96 = Vertex(name = 'V_96',
              particles = [ P.V, P.W__plus__, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
...
V_110 = Vertex(name = 'V_110',
               particles = [ P.V, P.Z, P.G0, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
               couplings = {(0,0):C.GC_91})

V_111 = Vertex(name = 'V_111',
               particles = [ P.V, P.Z, P.G__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
               couplings = {(0,0):C.GC_92})

V_112 = Vertex(name = 'V_112',
               particles = [ P.V, P.Z, P.H, P.H ],
               color = [ '1' ],
               lorentz = [ L.VVSS1 ],
               couplings = {(0,0):C.GC_91})

V_113 = Vertex(name = 'V_113',
               particles = [ P.V, P.Z, P.H ],
               color = [ '1' ],
               lorentz = [ L.VVS1 ],
...
V_141 = Vertex(name = 'V_141',
               particles = [ P.ve__tilde__, P.ve, P.V ],
               color = [ '1' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_52})

V_142 = Vertex(name = 'V_142',
               particles = [ P.vm__tilde__, P.vm, P.V ],
               color = [ '1' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_52})

V_143 = Vertex(name = 'V_143',
               particles = [ P.vt__tilde__, P.vt, P.V ],
               color = [ '1' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_52})
...
V_144 = Vertex(name = 'V_144',
               ...
               couplings = {(0,0):C.GC_52,(0,1):C.GC_54})
...
V_146 = Vertex(name = 'V_146',
               particles = [ P.ta__plus__, P.ta__minus__, P.V ],
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_52,(0,1):C.GC_54})

V_147 = Vertex(name = 'V_147',
               particles = [ P.u__tilde__, P.u, P.V ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_50,(0,1):C.GC_53})

V_148 = Vertex(name = 'V_148',
               particles = [ P.c__tilde__, P.c, P.V ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_50,(0,1):C.GC_53})

V_149 = Vertex(name = 'V_149',
               particles = [ P.t__tilde__, P.t, P.V ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_50,(0,1):C.GC_53})

V_150 = Vertex(name = 'V_150',
               particles = [ P.d__tilde__, P.d, P.V ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_50,(0,1):C.GC_51})

V_151 = Vertex(name = 'V_151',
               particles = [ P.s__tilde__, P.s, P.V ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_50,(0,1):C.GC_51})

V_152 = Vertex(name = 'V_152',
               particles = [ P.b__tilde__, P.b, P.V ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_50,(0,1):C.GC_51})
